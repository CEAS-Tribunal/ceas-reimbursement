...
function checkFile($file, $mb_size_limit, $expected_mime_types) {
    ...
    switch ($file['error']) {
        ...
        case UPLOAD_ERR_FORM_SIZE:
            $file_check_result->file_safe = false;
            $file_check_result->message = 'Exceeded filesize limit of ' . $mb_size_limit . "MB.";
        default:
            $file_check_result->file_safe = false;
            $file_check_result->message = 'Unknown errors. Try registering again. If the problem persists, select a different file or contact the number in the description.';
    }
